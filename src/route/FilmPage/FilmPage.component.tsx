...
import { PLAYER_VIDEO_SELECTOR_OVERLAY_ID, SCHEDULE_OVERLAY_ID, SCROLL_EVENT_END_PADDING } from './FilmPage.config';
...
export function FilmPageComponent({
  ...
  const renderSchedulePopup = (schedule: ScheduleInterface[]) => (
    <ThemedOverlay
