...
const Slider = forwardRef<SliderRef, SliderProps>(
  (
    ...
    const { _moveSlideTranslateX, _slideDotScaleX, _slideDotTranslateX } = animations;
    ...
    const panResponderConfig: PanResponderCallbacks = useMemo(() => {
      ...
      return {
        ...
        onMoveShouldSetPanResponderCapture: (_, gestureState) => gestureState.dx !== 0 && gestureState.dy !== 0,
