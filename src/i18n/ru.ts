...
const ru: Translations = {
  ...
  'Player buffer time settings': 'Настройки буфера плеера (Секунды)',
  ...
  'Toggle save quality.': 'Если включено, выбранное качество видео будет сохраняется при изменении в плеере.',
