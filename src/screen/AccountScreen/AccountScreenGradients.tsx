...
export const PremiumGradient = ({ style, size }: { style?: StyleProp<ViewStyle>, size: number }) => {
  return (
...
export const DefaultGradient = ({ style, size }: { style?: StyleProp<ViewStyle>, size: number }) => {
  return (
    <Svg style={ style } height={ size } width={ size }>
      <Defs>
        <RadialGradient
