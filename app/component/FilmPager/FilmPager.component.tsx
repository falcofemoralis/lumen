...
const LazyPlaceholder = ({ route }: any) => <ThemedView style={styles.lazyContainer}></ThemedView>;

export function FilmPagerComponent(props: FilmPagerComponentProps) {
  const { pagerItems, selectedPagerItem, onNextLoad, handleMenuItemChange } = props;
